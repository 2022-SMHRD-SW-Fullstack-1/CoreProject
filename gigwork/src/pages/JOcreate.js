...
const JOcreate = () => {
  ...
  const [enroll_company, setEnroll_company] = useState({
    address: ''  });
>>>>>>> 03ca3e1b7f6da9395affc375b99b37cab83464ea
...
<<<<<<< HEAD
  ...
  const handleCheckUrgent = (e) => {
    setUrgent(e.target.checked); console.log(e.target.checked)
  }
...
<<<<<<< HEAD
  ...
  useEffect(() => {
    setPostInfo({
      memId: 'tjdwns65', postCate: category, postPay: pay,
        ...
        <div className='postbox'>
          <div className='contentBox'>
            ...
            <div className='salary'>
              ...
              <div>
                <input type='checkbox' id='offerYesNo' onChange={handleOffer} value={offer} />{"\u00A0"}
                <span>제의받기</span>
              </div>
              <br />
            </div>
            <div className='datebox'>
              ...
              <div className='timebox'>
                <input type='checkbox' onChange={handleCheckUrgent} value={urgent} />{"\u00A0"}<span>급구</span>
              </div>
